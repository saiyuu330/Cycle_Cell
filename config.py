...
def parser():
    ...
    arg_parser.add_argument("--check_dir", default='./checkpoints', type=str, help="path to checkpoint directory")
    ...
    arg_parser.add_argument("--learning_rate", default=1e-4, type=float, help="learning rate")
