...
arg_parser.add_argument("--input_dir", required=True, help="path to input directory")
arg_parser.add_argument("--output_dir", required=True, help="path to output directory")
